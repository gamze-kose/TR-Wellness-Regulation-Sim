...
esenlik merkez ve ünitelerinin uluslararası sağlık turizmi yetkisine ilişkin
usul ve esasları Bakanlığın belirlemesine bırakmış, belirleme yayımlanmamış ve
Esenlik Hizmetleri Yönetmeliği EK-4'ünde konuyla ilgili tek bir soru bile yok.
"""
...
def turizm_durumu(senaryo, yil, merkez):
    ...
    Madde 17 kapsamındaki belirleme yapılmamışsa durum tanımsızdır.
    Kısıtlayıcı belirlemede üniteler kapsam dışı kalır.
    """
