...
| 🟣 **Belirsiz** | Kural ihlali yok, ancak Madde 17 kapsamındaki belirleme yapılmadığı için durum tanımsız. |
...
eşleştirilir. Bir ziyaretçi dört nedenden biriyle hizmet alamaz. Nekahet
dönemindeki kişi Madde 10/8-d gereği hizmet alamaz; bu bir mevzuat yasağıdır.
Aradığı hizmeti sunan merkez bulunmaması ve kapasitenin dolması ise arz ile
talebin buluşmamasından kaynaklanır, mevzuatla ilgisi yoktur. **Yalnızca yurt
dışında ikamet edenlerde Madde 17 devreye girer ve sonuç belirsiz olur.**
...
belirleme hiç yapılmıyor ve sonuç şeridinde mor bir **Tanımsız %7** bandı
beliriyor.
...
mor bant tamamen kayboluyor: **Tanımsız %0**. İki koşuda ziyaretçi sayısı da,
diğer bütün ayarlar da aynıdır; değişen tek şey senaryodur. Mor bandın yerini
büyük ölçüde yeşil bant alır.
...
**Bu on dört kayıttan simülasyona bağlı olan tek kayıt Madde 17 kapsamındaki
belirlemedir**; ziyaretçi sonuçlarındaki belirsiz durumu yalnızca ondan doğar.
Kalan on üç eksiklik belirlenmiş ancak modellenmemiştir. Örneğin nekahet
döneminin tanımsız olması modelde net bir evet ya da hayır olarak işlenir.
...
| 🟣 **Undefined** | No rule is violated, but the status is undetermined because no determination has been made under Article 17. |
...
persists**: no determination is ever made, and a purple **Undefined 7%** band
...
made in 2028 and the purple band disappears entirely: **Undefined 0%**. The
visitor count and every other setting are identical across the two runs; the
scenario is the only thing that changes.
...
- Where no determination is made, the share of visitors resident abroad
  obtaining service falls to **46%** by the tenth year and **11%** of demand
  remains undefined; where it is made in 2028, the share rises to **86%**.
